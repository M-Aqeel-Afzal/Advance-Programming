...
public void setup()
{
	...
	public void testInsertionInvalid() {                   //insertion with index is invalid
		...
		assertEquals(arr.insert(5,-1),null);
	}
	...
	@SuppressWarnings("static-access")
	@Test
	public void testDeletionInvalid() {        //Deleteion test when index is invalid
		
		assertEquals(arr.delete(-1),null);
	}
	...
	public void testBinarySearchInvalid() {                       //Valid Linear Search (searching 10 in the array)
		...
		assertEquals(arr.binarySearch(10,0,7),false);
	}
